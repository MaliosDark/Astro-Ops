 ...
 * Provides a client-side implementation for connecting to the WebSocket server
 */
...
class BonkRaidersWebSocketClient {
   ...
   */
  requestLeaderboard(type = 'missions', limit = 10) {
    return this.send('request_leaderboard', { type, limit });
  }

  /**
   * Request chat history
   */
  requestChatHistory(channel = 'global', limit = 20) {
    return this.send('request_chat_history', { channel, limit });
  }
